...
- Se añade `docs/merge-conflicts.md` con una guía rápida para resolver conflictos de merge explicando cuándo elegir *Current Change*, *Incoming Change* o combinar ambos y los pasos recomendados para AppGeoAnaliza.
